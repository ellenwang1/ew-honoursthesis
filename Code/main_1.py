...
def main():
	...
	np.save('/home/z5209394/Data/indices_used_1.npy', indices)
	np.save('/home/z5209394/Data/Y_test_filtered_1.npy', Y_test_filtered)	
	print("first filter applied")
	indices = np.load('/home/z5209394/Data/indices_used_1.npy')
	Y_test_filtered = np.load('/home/z5209394/Data/Y_test_filtered_1.npy')
	...
	np.save('/home/z5209394/Data/dataset_1.npy', dataset)
	np.save('/home/z5209394/Data/dataset_test_1.npy', dataset_test)
	np.save('/home/z5209394/Data/y_train_1.npy', Y_train)
	np.save('/home/z5209394/Data/y_test_1.npy', Y_test)
	...
	#accuracy_list = []
	#error_list = []
	#no_trees = [50, 100, 200, 300, 500, 1000, 2000, 3000, 5000, 7500, 10000]
	#for i in no_trees:
	#	max features, min sample split 
	#	clf = RandomForestClassifier(n_estimators = i, criterion = 'gini', oob_score = True, bootstrap = True)
