...
def main():
	...
	# Saved classifier
	classifier = RandomForestClassifier()
	params = {'oob_score': True, 'n_estimators': 15000, 'min_samples_split': 3, 'max_features': 10, 'criterion': 'gini', 'bootstrap': True, 'max_samples': 21600, 'n_jobs': 16}
	...
	variable_arr = [
       ...
       'mid_med_ratio_th_T1_inc', 'mid_th_T1', 'H_bh_T1_e3',
       'mid_small_ratio_th_st_inc', 'H_stm_e1',
       'mid_small_ratio_bh_FLAIR', 'mid_med_ratio_bh_FLAIR_inc',
       'mid_small_ratio_FLAIR_inc', 'WMH_y', 'mid_med_ratio_stm',
       'mid_vsmall_ratio_th_T1_inc', 'H_bh_st_e2', 'WMH_x', 'H_bh_st_e1',
       'mid_vsmall_ratio_th_T1', 'mid_small_ratio_FLAIR', 'H_bh_st_e3',
       'mid_vsmall_ratio_th_st_inc', 'H_bh_FLAIR_e2', 'H_stm_e2',
       'H_th_FLAIR_e1', 'H_bh_T1_e2', 'mid_large_ratio_th_T1',
       'min_th_T1', 'H_bh_FLAIR_e3', 'mid_med_ratio_stm_inc', 'H_T1_e3',
       'mid_small_ratio_bh_FLAIR_inc', 'med_FLAIR', 'density_diff',
       'mid_large_ratio_th_st_inc', 'mid_large_ratio_bh_st',
       'H_bh_FLAIR_e1', 'H_FLAIR_e1', 'var_th_st', 'WMH_z', 'H_FLAIR_e2',
       'mid_large_ratio_bh_T1_inc', 'mid_T1', 'mid_large_ratio_bh_T1',
       'mid_large_ratio_th_st', 'mid_vsmall_ratio_bh_st', 'H_T1_e2',
       'H_stm_e3', 'min_bh_st', 'min_bh_FLAIR', 'med_th_T1',
       'mid_vsmall_ratio_bh_T1', 'H_FLAIR_e3',
       'mid_vsmall_ratio_bh_st_inc', 'mid_vsmall_ratio_bh_T1_inc',
       'mid_vsmall_ratio_T1', 'mid_vsmall_ratio_T1_inc', 'mean_bh_st',
       'mean_th_st', 'med_bh_FLAIR', 'mid_med_ratio_st_inc',
       'mid_vsmall_ratio_st_inc', 'var_bh_T1', 'mid_vsmall_ratio_stm_inc',
       'CSF', 'min_bh_T1', 'mid_vsmall_ratio_st',
       'mid_large_ratio_th_FLAIR_inc', 'mid_med_ratio_st', 'med_th_FLAIR',
       'mid_large_ratio_th_FLAIR', 'min_th_st', 'mid_small_ratio_T1',
       'mid_vsmall_ratio_stm', 'mean_th_FLAIR', 'mid_small_ratio_bh_T1',
       'mid_vsmall_ratio_bh_FLAIR', 'mid_vsmall_ratio_th_FLAIR',
       'var_bh_st', 'range_bh_st', 'mid_small_ratio_st_inc',
       'mid_small_ratio_bh_T1_inc', 'mid_large_ratio_T1_inc',
       'mid_vsmall_ratio_th_FLAIR_inc', 'mid_small_ratio_T1_inc',
       'med_bh_st', 'mid_large_ratio_T1', 'var_th_FLAIR', 'range_T1',
       'mid_small_ratio_bh_st', 'mid_vsmall_ratio_bh_FLAIR_inc',
       'mid_med_ratio_T1_inc', 'mid_small_ratio_stm', 'mid_med_ratio_T1',
       'mid_small_ratio_st', 'mean_bh_FLAIR', 'mean_FLAIR',
       'mid_small_ratio_stm_inc', 'max_bh_st',
       'mid_small_ratio_bh_st_inc', 'mid_large_ratio_FLAIR_inc',
       'mid_large_ratio_FLAIR', 'mid_med_ratio_bh_T1',
       'mid_large_ratio_stm', 'mid_large_ratio_stm_inc',
       'mid_med_ratio_bh_T1_inc', 'max_bh_T1', 'max_th_st', 'med_th_st',
       'GM', 'range_th_st', 'range_th_T1', 'mid_FLAIR', 'WM',
       'range_bh_FLAIR', 'var_bh_FLAIR', 'var_st', 'range_th_FLAIR',
       'mean_th_T1', 'mid_med_ratio_bh_st_inc', 'mid_vsmall_ratio_FLAIR',
       'mid_med_ratio_bh_st', 'mid_vsmall_ratio_FLAIR_inc',
       'mid_large_ratio_st_inc', 'mid_large_ratio_st',
       'sum_soft_tiss_binary', 'mean_bh_T1', 'med_st', 'var_T1',
       'range_bh_T1', 'max_bh_FLAIR', 'max_stm', 'var_FLAIR', 'range_stm',
       'mean_T1', 'max_th_FLAIR', 'med_bh_T1', 'var_stm', 'med_T1',
       'mean_st', 'min_T1', 'max_th_T1', 'var_th_T1', 'range_FLAIR',
       'max_FLAIR', 'med_stm', 'mean_stm', 'sum_percent_soft_tiss', 'y',
       'x', 'z']
