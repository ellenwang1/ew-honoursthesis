...
def main():
	...
	rf_random = model_selection.RandomizedSearchCV(estimator = rf_base, scoring = 'accuracy', param_distributions = rf_grid, refit = 'oob_error',
	...
	# Saved classifier
	#classifier = RandomForestClassifier()
	#params = {'oob_score': True, 'n_estimators': 5000, 'min_samples_split': 2, 'max_features': 22, 'criterion': 'gini', 'bootstrap': True}
