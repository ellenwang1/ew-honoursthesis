...
def main():
	...
	variable_arr = ['mid_small_ratio_stm_inc', 'mid_med_ratio_bh_T1', 'mid_small_ratio_stm', 'mid_large_ratio_bh_st', 'mid_small_ratio_st', 'H_stm_e2', 'mid_large_ratio_bh_st_inc', 'H_bh_st_e2', 'mid_large_ratio_bh_T1_inc', 'H_T1_e2', 'range_st', 'H_st_e1', 'H_st_e2', 'H_st_e3', 'mean_bh_st', 'mid_vsmall_ratio_bh_T1_ied_ratio_bh_FLAInc', 'H_bh_T1_e2', 'H_bh_T1_e3', 'H_th_T1_e3', 'mid_med_ratio_bh_FLAIR', 'mid_small_ratio_FLAIR', 'H_bh_st_e3', 'mid_large_ratio_bh_T1', 'min_th_FLAIR', 'min_th_T1', 'mid_vsmall_ratio_bh_st_th_st_inc', 'mininc', 'mid_vsmall_ratio_th_T1_inc', 'H_bh_T1_e1', 'H_bh_st_e1', 'H_stm_e1', 'H_th_T1_e2', 'mid_med_ratio_th_T1_inc', 'mid_bh_FLAIR', 'mid_vsmall_ratio_th_st_inc', 'mid_large_ratio_bh_FLAIR ', 'mid_th_st', 'mid_med_ratio_bh_FLAIR_inc', 'mid_vsmall_ratio_bh_st', 'H_stm_e3', 'mid_small_ratio_FLAIR_inc', 'mid_small_ratio_st_inc', 'med_bh_FLAIR', 'mid_small_ratio_th_FLAIR', 'H_th_st_e3', 'mid_bh_T1d_large_ratio_bh', 'mid_th_T1', 'mid_small_ratio_th_T1', 'H_th_st_e1', 'mid_med_ratio_th_T1', 'mid_small_ratio_th_T1_inc', 'mid_vsmall_ratio_bh_T1', 'mid_med_ratio_th_FLAIR', 'WMH_y', 'H_T1_e3', 'density_dimid_vsmall_ratioff', 'mid_large_ratio_th_T1', 'mid_vsmall_ratio_st_inc', 'WMH_z', 'mid_small_ratio_th_FLAIR_inc', 'min_bh_st', 'H_th_T1_e1', 'mid_th_FLAIR', 'mid_large_ratio_th_T1_inc', 'min_FLAIR', 'mid_lad_small_ratio_thrge_ratio_bh_FLAIR_inc', 'med_bh_st', 'H_th_st_e2', 'mean_bh_FLAIR', 'WMH_x', 'mid_vsmall_ratio_th_st', 'mid_large_ratio_bh_FLAIR', 'mid_th_st', 'mid_med_ratio_th_st', 'mid_large_ratio_th_FL_bh_st', 'mid_laAIR_inc', 'mid_vsmall_ratio_st', 'mid_small_ratio_bh_FLAIR', 'H_bh_FLAIR_e1', 'mid_large_ratio_th_FLAIR', 'mid_med_ratio_th_FLAIR_inc', 'mid_small_ratio_th_st', 'mid_large_ratio_th_st', 'midr_bh_T1', 'mid_l_small_ratio_T1_inc', 'mid_small_ratio_bh_FLAIR_inc', 'range_bh_st', 'mid_med_ratio_th_st_inc', 'H_bh_FLAIR_e2', 'H_th_FLAIR_e2', 'mid_small_ratio_th_st_inc', 'mid_T1', 'mid_large_ratio_th_sh_T1', 'min_bh_Ft_inc', 'med_th_FLAIR', 'mean_FLAIR', 'min_bh_FLAIR', 'H_th_FLAIR_e3', 'med_th_T1', 'H_bh_FLAIR_e3', 'mid_small_ratio_bh_T1', 'mid_small_ratio_T1', 'H_th_FLAIR_e1', 'mid_small_ratio_bh_T1_instm', 'mid_largec', 'mid_med_ratio_bh_st', 'min_th_st', 'var_th_FLAIR', 'mean_th_FLAIR', 'mid_FLAIR', 'mid_small_ratio_bh_st', 'mid_small_ratio_bh_st_inc', 'var_bh_T1', 'var_th_st', 'mid_large_ratio_stm', 'nc', 'mean_bh_T1min_bh_T1', 'mid_large_ratio_stm_inc', 'mid_med_ratio_bh_st_inc', 'med_FLAIR', 'H_FLAIR_e2', 'H_FLAIR_e1', 'mid_large_ratio_T1_inc', 'mid_large_ratio_T1', 'mean_th_st', 'max_bh_st', 'var_bh_max_th_FLAIR', 'FLAIR', 'range_th_st', 'range_th_FLAIR', 'mean_bh_T1', 'mid_large_ratio_st', 'H_FLAIR_e3', 'var_bh_st', 'mid_large_ratio_st_inc', 'WM', 'GM', 'mean_th_T1', 'max_th_st', 'var_st', 'range_th_T_st', 'mid_large1', 'med_bh_T1', 'mid_vsmall_ratio_bh_FLAIR', 'range_bh_FLAIR', 'var_FLAIR', 'sum_soft_tiss_binary', 'med_th_st', 'max_th_FLAIR', 'mid_vsmall_ratio_bh_FLAIR_inc', 'mid_vsmall_ratio_th_FLAIR_inc' , 'med_st', 'mid_large_ratio_FLAIR_inc', 'mid_large_ratio_FLAIR', 'mid_vsmall_ratio_th_FLAIR', 'max_bh_T1', 'max_stm', 'min_T1', 'range_stm', 'var_T1', 'mean_T1', 'var_th_T1', 'max_FLAIR', 'mean_st', 'range_T1', 'range_bh_T1', 'range_FLAIR', 'med_T1', 'max_bh_FLAIR', 'var_stm', 'x', 'mid_vsmall_ratio_FLAIR', 'mid_vsmall_ratio_FLAIR_inc', 'max_th_T1', 'y', 'med_stm', 'mean_stm', 'sum_percent_soft_tiss', 'z']
